...
#     print("I called f1()")
#     f1()        
#     print("I returned from f1()")
   
                    
# try:
#     print("I called f()")
#     f()
#     print("I returned from f()")
# except ValueError: # IndexError # Exception # or blank
#     print("I am in grave exception ")
# finally:
#     print("I am executed not matter what happened ")    
