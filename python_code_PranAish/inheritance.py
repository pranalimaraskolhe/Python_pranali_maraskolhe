...
# class Diot_student(Student):
#     pass

# Hrithik = Diot_student("Hrithik",3,300,"DIOT")
...
class Diot_student(Student):
    ...
    def unenroll(self):
        ...
        self.student_enrolled_coursename = "DIOT"    
    ...
    def unenroll(self,bank_balance=100):
        if bank_balance > 50000: 
            ...
            self.student_enrolled_coursename = "IOT"    
...
Hrithik = Diot_student("Hrithik",1,100,'Python',["C","C++","Python"])

# accessing things that the parent class provides and also defined in Diot_student class
