# different ways of creating a string literal
""
''
""" """
''' '''
...
my_char_string = "t"
my_dict = {"name" : "Aishwarya" , "rollno" : 7}
...
print("My my_name element in the dictionary is " , my_dict["name"] )
...
print(f"my name is {my_name*3} my_rollno is {my_rollno*2}" )